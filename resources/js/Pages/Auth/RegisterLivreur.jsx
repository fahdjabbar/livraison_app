...
export default function RegisterLivreur() {
    ...
    return (
        <GuestLayout title="Inscription - Livreur">
            <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
                <h2 className="text-2xl font-bold mb-6 text-center">Inscription Livreur</h2>
                <form onSubmit={submit}>
                    ...
                    <div className="mb-4">
                        ...
                        <TextInput
                            ...
                            required
                        />
                        <InputError message={errors.password} className="mt-2" /> {/* Ajuster l'erreur */}
                    </div>
                    ...
                    <div className="mb-4">
                        <InputLabel value="Disponibilité" />
                        <input
                            type="checkbox"
