...
use App\Notifications\LivreurAffecte;
use App\Notifications\CommandeLivree;
use App\Notifications\CommandeAnnulee;
...
class CommandeController extends Controller
{
    ...
    public function destroy(Commande $commande)
    {
        ...
        $commande->client->notify(new CommandeAnnulee($commande));
        if ($commande->livreur) {
            $commande->livreur->notify(new CommandeAnnulee($commande));
        }
    ...
    public function affecter(Request $request, Commande $commande)
    {
        ...
        $livreur->notify(new LivreurAffecte($commande));
    ...
    public function suivi(Commande $commande)
{
    ...
    public function marquerLivree(Commande $commande)
    {
        ...
        $commande->client->notify(new CommandeLivree($commande));
    ...
    public function store(Request $request)
    {
        ...
        $request->user()->notify(new CommandeCreee($commande));
